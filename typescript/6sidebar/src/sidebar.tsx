...
export default function Sidebar() {
  ...
  return (
    <Box  sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar className="mainColor" position="fixed" open={open}>
        <Toolbar>
          <IconButton
            color="inherit"
          ...
          {dataRes.map((text, index) => (
            ...
            <ListItem key={text.id} disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                ...
                style={{background:text.path === location.pathname?"#1976d2":"#1976d2"}}
              >
                <ListItemIcon
                  sx={[
                    {
                  ...
                  style={{color:text.path === location.pathname?"#ffffff":"#ffffff"}}
                >
